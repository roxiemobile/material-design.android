...
public class InterpolatingLayout extends ViewGroup {
    ...
    private final Rect mInRect = new Rect();
    ...
    public final static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.MDG_InterpolatingLayout);

            narrowParentWidth = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_narrowParentWidth, -1);
            narrowWidth = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_narrowWidth, -1);
            narrowMarginLeft = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_narrowMarginLeft, -1);
            narrowPaddingLeft = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_narrowPaddingLeft, -1);
            narrowMarginRight = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_narrowMarginRight, -1);
            narrowPaddingRight = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_narrowPaddingRight, -1);
            wideParentWidth = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_wideParentWidth, -1);
            wideWidth = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_wideWidth, -1);
            wideMarginLeft = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_wideMarginLeft, -1);
            widePaddingLeft = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_widePaddingLeft, -1);
            wideMarginRight = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_wideMarginRight, -1);
            widePaddingRight = a.getDimensionPixelSize(
                    R.styleable.MDG_InterpolatingLayout_layout_widePaddingRight, -1);
