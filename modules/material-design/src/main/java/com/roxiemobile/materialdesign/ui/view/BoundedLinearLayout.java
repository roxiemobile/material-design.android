...
// MARK: - Methods
    ...
    protected void onInitInterface(AttributeSet attrs) {
        TypedArray types = getContext().obtainStyledAttributes(attrs, R.styleable.MDG_BoundedLinearLayout);

        // Init instance variables
        mMaxWidth  = types.getDimensionPixelSize(
                R.styleable.MDG_BoundedLinearLayout_layout_maxWidth,  0);
        mMaxHeight = types.getDimensionPixelSize(
                R.styleable.MDG_BoundedLinearLayout_layout_maxHeight, 0);
