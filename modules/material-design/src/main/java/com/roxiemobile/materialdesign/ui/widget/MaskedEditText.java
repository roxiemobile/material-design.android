...
// MARK: - Construction
    ...
    protected void processAttributes(Context context, AttributeSet attributeSet)
    {
        ...
        TypedArray attrs = context.obtainStyledAttributes(attributeSet, R.styleable.MDG_MaskedEditText);

        // Init instance
        String inputMask = attrs.getString(R.styleable.MDG_MaskedEditText_inputMask);
        setInputMask(inputMask);

        String regexMask = attrs.getString(R.styleable.MDG_MaskedEditText_regexMask);
