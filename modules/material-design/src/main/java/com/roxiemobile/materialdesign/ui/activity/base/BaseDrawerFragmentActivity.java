    ...
    protected void onInitInterface(Intent intent, Bundle extras, Bundle savedInstanceState) {
        ...
        if (mDrawerLayout != null) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                mDrawerLayout.setDrawerShadow(R.drawable.mdg__ic_vertical_shadow, GravityCompat.START);
            }
        }
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, toolbar, R.string.mdg__drawer_open, R.string.mdg__drawer_close);
